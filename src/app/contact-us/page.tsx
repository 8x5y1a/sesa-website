...
const ContactUsPage: React.FC = () => {
  return (
    <div
      className="min-h-screen text-white font-heading p-8"
      style={{
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-[48px] uppercase mt-4 font-vcr">Get in touch</h1>


          <p className="text-[20px] font-[Monocode] text-thistle mt-4 max-w-[558px]">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 bg-blueviolet-100 hover:bg-blueviolet-200 text-white rounded uppercase flex items-center gap-x-2 font-vcr"
          >
          ...
          <div className="mt-4 text-base font-[Monocode] text-thistle">
